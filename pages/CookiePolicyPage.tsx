...
import { COOKIE_POLICY_TEXT_EN, COOKIE_POLICY_TEXT_ES } from '../constants'; 

const CookiePolicyPage: React.FC = () => {
  const { i18n } = useTranslation(); // t function not used directly here
  const content = i18n.language.startsWith('es') ? COOKIE_POLICY_TEXT_ES : COOKIE_POLICY_TEXT_EN;
